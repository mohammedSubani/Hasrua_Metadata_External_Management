...
if ($osType -eq "linux") {
    Write-Host "[OK] Docker Desktop is in Linux container mode!" -ForegroundColor Green
    Write-Host ""
    ...
    Write-Host "[WARNING] Could not determine Docker mode. Is Docker Desktop running?" -ForegroundColor Yellow
    Write-Host ""
